...
class BertModel(object):
  ...
  def __init__(self,
    ...
    with tf.variable_scope(scope, default_name="bert", reuse=tf.AUTO_REUSE):
      with tf.variable_scope("embeddings"):
        ...
        self.position_embedding_output] = embedding_postprocessor(
      ...
      with tf.variable_scope("encoder"):
        ...
        self.attn_maps] = transformer_model(
            input_tensor=self.embedding_output,
  ...
  def get_relative_position_table(self):
    return self.relative_position_table
...
def _generate_relative_positions_embeddings(length, depth,
 ...
 # '''
  ...
  relative_position_embeddings_bi = tf.expand_dims(relative_position_embeddings_bi, axis=0)
