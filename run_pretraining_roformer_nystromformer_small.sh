nohup python run_pretraining_roformer_nystromformer.py \
	--bert_config_file ./config/bert_config_small_roformer_nystromformer.json \
	--input_file chinese_simplified_whole_sentence_v3_32/chinese_simplified_whole_sentence_file.txt \
	--output_dir gs://yyht_source/pretrain/models/bert_small_roformer_nystromformer_conv_50g \
