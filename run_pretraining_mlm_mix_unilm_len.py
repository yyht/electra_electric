...
import os
from model import modeling_bert_unilm_len
...
def model_fn_builder(bert_config, init_checkpoint, learning_rate,
  ...
  def model_fn(features, labels, mode, params):  # pylint: disable=unused-argument
    ...
    mlm_model = modeling_bert_unilm_len.BertModel(
        config=bert_config,
    ...
    ilm_model = modeling_bert_unilm_len.BertModel(
        config=bert_config,
        is_training=is_training,
    ...
    if init_checkpoint:
      ...
      ) = modeling_bert_unilm_len.get_assignment_map_from_checkpoint(tvars, init_checkpoint)
      if use_tpu:
