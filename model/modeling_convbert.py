...
"""The transformer encoder, BERT and ConvBERT architecture. (Essentially BERT's with a few
...
class BertModel(object):
  ...
  model for ELECTRA is the same as BERT's. ConvBERT is built on top of ELECTRA with
