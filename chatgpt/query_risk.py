...
openai.api_key = "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"
...
with open('/home/htxu91/source/rlhf/black_final.json.detail', 'w') as fwobj:
	with open('/home/htxu91/source/rlhf/black_final.json', 'r') as frobj:
