nohup python run_pretraining_convbert.py \
	--bert_config_file ./config/bert_config_xtiny_2_official_conv.json \
	--input_file chinese_simplified_whole_sentence_v3_32/chinese_simplified_whole_sentence_file.txt \
	--output_dir gs://yyht_source/pretrain/models/convbert_xtiny_2_50g \
