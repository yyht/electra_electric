...
from model.funnel_transformer_utils import conv1d_transpose
from model.funnel_transformer_utils import model_utils
...
def bridge_deconv_layer(net_config, hiddens, input_mask,
	...
	with tf.variable_scope("upsampling_layer", reuse=reuse):
		features = hiddens[-1]
		input_shape = model_utils.get_shape_list(features)
