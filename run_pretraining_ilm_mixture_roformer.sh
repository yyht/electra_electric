nohup python3 run_pretraining_ilm_mixture_roformer.py \
	...
	--output_dir gs://yyht_source/pretrain/models/bert_base_roformer_50g_latest_ilm_mixture \
	--input_data_dir gs://yyht_source/pretrain \
	--init_checkpoint models/bert_base_roformer_50g_latest_ilm/model.ckpt-1000000 \
	--max_seq_length 512 \
	--real_max_length 664 \
	--do_train True \
