nohup python3 run_pretraining_convbert.py \
	--bert_config_file ./config/bert_config_large_official_conv_datagrand.json \
	--input_file datagrand21/datagrand_21_file_list.txt \
	--output_dir gs://yyht_source/pretrain/models/datagrand_21_convbert_large_rdrop_nosimcse \
